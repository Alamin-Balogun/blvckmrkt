...
func Register(r *gin.Engine) {
	...
	brand := api.Group("/brand", middleware.Auth(), middleware.RequireBrand(), middleware.RequireVerifiedBrand())
	{
		...
		brand.POST("/orders/dellyman/:delivery_id/confirm-pickup", handlers.BrandConfirmDellymanPickup)
		...
		brand.PATCH("/addresses/:id/dellyman-pickup", handlers.BrandSetDellymanPickupAddress)
