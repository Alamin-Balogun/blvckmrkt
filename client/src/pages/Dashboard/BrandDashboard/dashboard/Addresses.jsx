...
export default function BrandAddresses() {
    ...
    <div
      ...
      <div style={{display: "flex", flexDirection: "column", gap: 10}}>
        <div>
          <Label>Label</Label>
          <input
            placeholder="HQ, Warehouse, Studio…"
            value={form.label}
    ...
    <div>
      <style>{`
        ...
        @media(max-width:480px){
          .addr-form-row{grid-template-columns:1fr!important;}
      ...
      {loading ? (
        ...
        <div
          ...
          <p style={{color: "rgba(255,255,255,0.2)", fontSize: 12}}>
            Add your HQ, warehouse, or studio addresses.
          </p>
        </div>
      ) : (
        <div className="addr-grid">
          {addresses.map((addr) => (
            <div
              ...
              onMouseEnter={(e) => {
                if (!addr.is_default) e.currentTarget.style.borderColor = "rgba(255,255,255,0.14)";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.borderColor = addr.is_default
                  ? "rgba(239,68,68,0.25)"
