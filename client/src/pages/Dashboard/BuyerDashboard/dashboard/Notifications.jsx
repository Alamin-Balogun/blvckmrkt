...
export default function Notifications({autoOpenId, onClearOpen}) {
  ...
  useEffect(() => {
    if (!autoOpenId || loading || notifs.length === 0) return;
  ...
  const handleMarkAll = async () => {
    try {
      await markAllRead(); // backend handles personal + broadcasts together
